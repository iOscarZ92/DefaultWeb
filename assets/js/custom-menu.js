...
//
	...
	//AtencionSiniestros
		$('.a-clientes li .siniestros').click(function(){
		...
		$('#collapseThree').parent().find('a').click();
		});
	
	//OficinaVentas
		$('.a-clientes li .ofiventas').click(function(){
		...
		$('#collapseTwo').parent().find('a').click();
		});
